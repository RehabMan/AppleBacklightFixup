KEXT=AppleBacklightFixup.kext
DIST=RehabMan-BacklightFixup
BUILDDIR=./Build
...
distribute:
	...
	cp LICENSE.txt ./Distribute
	cp $(BUILDDIR)/SSDT-PNLF.aml ./Distribute
	rm -f ./Distribute/Release/*.zip
